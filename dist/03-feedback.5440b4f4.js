...
var _functionsForFormJs = require("./functions-forForm.js");
...
},{"./functions-forForm.js":"7DCtp"}],"7DCtp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "onInput", ()=>onInput);
parcelHelpers.export(exports, "onTextArea", ()=>onTextArea);
var _lodashThrottle = require("lodash.throttle");
var _lodashThrottleDefault = parcelHelpers.interopDefault(_lodashThrottle);
function onInput({ target  }) {
    if (target || textarea !== "") localStorage.setItem("userEmail", target.value);
}
function onTextArea({ target  }) {
    if (target || textarea !== "") localStorage.setItem("userMessage", target.value);
}
